...
class PersonalCabinetPage extends Component {
    ...
    state={
        iamuser:{
            name: "Фаррух",
            photo: "https://cdn.shopify.com/s/files/1/0042/8641/4961/products/natna-shop-clothes-pink-3t-shirt-boys-long-sleeve-school-boys-dress-shirts-for-children-baby-clothes-for-kids-boys-collar-shirt-formal-birthday-shirts-7239053082737_1024x1024.jpg?v=1588985297"
        }
    }
            ...
            <div className="personal-cabinet-page">
                ...
                <div className="row">
                        <div className="col-xl-3 col-lg-3 col-md-4 col-sm-12">
                            <HelloBox name={this.state.iamuser.name}/>
                            <Chat iamuser={this.state.iamuser}/>
